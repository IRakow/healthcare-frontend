...
-- Patients can upload their own media (organized by user ID)
...
-- Patients can update their own media
create policy "Patients can update own media"
...
-- Patients can delete their own media
create policy "Patients can delete own media"
...
-- Public access enabled for AI analysis (bucket is public)
-- No additional policy needed as bucket is set to public: true
