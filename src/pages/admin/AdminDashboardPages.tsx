...
export function AdminSuperPanelPage() {
  ...
  return (
    <AdminLayout>
      ...
      <AdminAssistantBar onAsk={(text) => handleAdminCommand(text, 'system')} />
    </AdminLayout>
  )
}
...
export function AdminVisualInspectorPage() {
  ...
  return (
    <AdminLayout>
      ...
      <AdminAssistantBar onAsk={(text) => handleAdminCommand(text, 'ui')} />
    </AdminLayout>
  )
}
...
export function AdminRachelLaunchboard() {
  ...
  return (
    <AdminLayout>
      ...
      <AdminAssistantBar onAsk={(text) => handleAdminCommand(text, 'launchboard')} />
    </AdminLayout>
  )
}