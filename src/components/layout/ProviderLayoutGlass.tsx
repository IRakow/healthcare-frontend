// File: src/components/layout/ProviderLayoutGlass.tsx
...
export default function ProviderLayoutGlass({ children }: ProviderLayoutProps) {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-white to-blue-50 flex">
      <Button
        variant="ghost"
        size="icon"
