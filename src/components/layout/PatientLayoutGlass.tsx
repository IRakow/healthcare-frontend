// File: src/components/layout/PatientLayoutGlass.tsx
...
export default function PatientLayoutGlass({ children }: PatientLayoutProps) {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-white via-[#e0f7fa] to-[#b2ebf2] flex">
      {/* Mobile Menu Toggle */}
      <Button
        variant="ghost"
        size="icon"
      ...
      <aside
        ...
        } lg:translate-x-0 transition-transform duration-200 ease-in-out w-72 bg-white/70 backdrop-blur-xl shadow-lg border-r border-gray-200`}
      >
        <div className="p-6">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">{branding.employer_name || 'Patient Name'}</h3>
